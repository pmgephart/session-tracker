		...
		<div className="workout rounded border p-5 mb-5">
            ...
            <div className="flex gap-4">
	            <div className="w-1/2 pb-5">
	                ...
	                <input
	                    ...
	                    onChange={(event) => handleWorkoutChange(event, index, "sets")}
	                    className="w-full bg-white rounded px-3 py-2 transition duration-300 ease focus:outline-none shadow-sm focus:shadow-md"
	                />
	            </div>
	            <div className="w-1/2 pb-5">
	                ...
	                <input
	                    ...
	                    onChange={(event) => handleWorkoutChange(event, index, "reps")}
	                    className="w-full bg-white rounded px-3 py-2 transition duration-300 ease focus:outline-none shadow-sm focus:shadow-md"
	                />
	            </div>
	        </div>
            <div className="w-full pb-5">
                ...
                <input
                    ...
                    onChange={(event) => handleWorkoutChange(event, index, "weight")}
                    className="w-full bg-white rounded px-3 py-2 transition duration-300 ease focus:outline-none shadow-sm focus:shadow-md"
                />
            </div>
            <div className="w-full pb-5">
